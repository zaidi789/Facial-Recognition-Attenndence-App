...
export default class FaceApiTest extends Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      img1: require('../Images/ChrissEvans.jpg'),
      img2: require('../Images/Chriss.jpg'),
      similarity: 'nil',
      liveness: 'nil',
    };
  }
  ...
  clearResults() {
    this.setState({
      img1: require('../Images/Chriss.jpg'),
      img2: require('../Images/ChrissEvans.jpg'),
      similarity: 'nil',
      liveness: 'nil',
    });
